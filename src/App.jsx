...
export default function App() {
  ...
  return <><AnimatePresence>{!booted && <BootScreen onComplete={() => setBooted(true)} />}</AnimatePresence><DataRain /><div className="scanlines" aria-hidden="true" />
    ...
    <section className="identity-deck" aria-labelledby="identity-title"><div className="identity-visual"><div className="portrait-frame"><img src="https://github.com/Amirgh23.png?size=600" alt="Amirreza Ghaffarian" /><div className="portrait-grid" /><div className="scan-beam" /><i className="corner tl" /><i className="corner tr" /><i className="corner bl" /><i className="corner br" /></div><div className="orbit-ring ring-one" /><div className="orbit-ring ring-two" /><div className="biometric-tag">BIOMETRIC MATCH // 99.7%</div></div><motion.div className="identity-copy" initial={reduceMotion ? false : { opacity: 0, x: 35 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}><span>00 // AUTHORIZED OPERATOR</span><h2 id="identity-title">AMIRREZA<br /><em>GHAFFARIAN</em></h2><p>AI &amp; Robotics engineer architecting autonomous systems at the edge of intelligence, perception and human interface.</p><div className="identity-data"><div><small>CODENAME</small><b>AMIRGH23</b></div><div><small>ROLE</small><b>MASTER AI ENGINEER</b></div><div><small>BASE</small><b>MASHHAD // IRAN</b></div><div><small>STATUS</small><b className="online">● OPERATIONAL</b></div></div><a href="https://github.com/Amirgh23" target="_blank" rel="noreferrer">OPEN GITHUB IDENTITY <Github /></a></motion.div></section>
